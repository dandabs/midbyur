...
export type { FooterLink, FooterProps } from "./components/Footer/Footer";
export { FooterText } from "./components/FooterText/FooterText";
export type { FooterTextProps } from "./components/FooterText/FooterText";
...
export { RootNavbar } from "./components/RootNavbar/RootNavbar";
export type { RootNavbarLink, RootNavbarProps } from "./components/RootNavbar/RootNavbar";
...
export { MandatorySign } from "./components/MandatorySign/MandatorySign";
